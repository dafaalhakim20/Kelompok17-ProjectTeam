...
hal = Image.open('3.png')
h = hal.resize((600,400),Image.LANCZOS)
hal2 = ImageTk.PhotoImage(h)
...
def halaman1():
    ...
    home1.pack(padx=80,pady=20,anchor='s',side='right')
    home2 = tk.Button(label,image=quit2,cursor='hand2',relief='sunken',border=0,command=quit)
    home2.pack(padx=80,pady=20,anchor='s',side='left')
...
def halaman2():
    ...
    l = tk.Label(frame2,image=hal2,border=0,bg='white')
